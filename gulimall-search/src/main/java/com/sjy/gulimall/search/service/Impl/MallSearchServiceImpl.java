package com.sjy.gulimall.search.service.Impl;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.TypeReference;
import com.sjy.common.es.SkuEsModel;
import com.sjy.common.utils.R;
import com.sjy.gulimall.search.config.GulimallElasticSearchConfig;
import com.sjy.gulimall.search.constants.EsConstant;
import com.sjy.gulimall.search.feign.ProductFeignService;
import com.sjy.gulimall.search.service.MallSearchService;
import com.sjy.gulimall.search.vo.AttrResponseVo;
...
public class MallSearchServiceImpl implements MallSearchService {
    ...
    private SearchRequest buildSearchRequest(SearchParam param) {
        ...
        if(!StringUtils.isEmpty(param.getSort())){
            ...
            builder.sort(sortFileds[0],sortOrder);
        }
        ...
        log.debug("构建的DSL语句 {}",builder.toString());
